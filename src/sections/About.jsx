        ...
        <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full'>
            ...
            <div className='xl:col-span-2 xl:row-span-3 hover:scale-102 transition duration-300'>
                <div className='grid-container'>
                    ...
                    <div>
                        <p className='grid-headtext'>Un poco sofsdfsdfbre mi</p>
            ...
            <div className='xl:col-span-1 xl:row-span-2 hover:scale-102 transition duration-300'>
                <div className='grid-container'>
                    ...
                    <div className='space-y-2'>
                       { /*<p className='text-white text-center animate-bounce mt-6'>joaquin.sanchewrwerez.suazo@gmail.com</p>
                       ...
                       <div>
                            <a href="/download/Joaquin_Sanchez_CV.pdf" download="Joaquin_Sanchez_cv.pdf" className='text-white' target="_blank" type='application/pdf'>Descargar</a>
                       </div>
